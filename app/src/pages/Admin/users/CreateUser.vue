...
<template>
  ...
  <form action="#" method="post" @submit.prevent="createUser">
    ...
    <div class="mt-4">
      ...
      <input type="email" name="email" placeholder="E-mail" v-model="email" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 p-2" :class="{ 'has-error': errors.validations.hasOwnProperty('email') }">
    </div>
    <div class="mt-4">
      <label for="senha" class="block text-sm font-medium leading-6 text-gray-900">Senha:</label>
      <input type="password" name="password" placeholder="Senha" v-model="password" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 p-2" :class="{ 'has-error': errors.validations.hasOwnProperty('password') }">
    </div>
